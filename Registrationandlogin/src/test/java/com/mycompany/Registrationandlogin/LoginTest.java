...
public class LoginTest {
    ...
    //I am creating the the input for the login test, this imput is exactly from the registration portal.
  ...
  // I am creating to test the username if it is incorrect. 
    @Test
    ...
    //Tests if the password is correctly formatted
    @Test
    ...
    //Tests if the password is incorrectly formatted
    @Test
